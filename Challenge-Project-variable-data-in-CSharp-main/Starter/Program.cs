    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            while (dogCharacteristic == "")
            {
                ...
                Console.WriteLine($"\r\nEnter one or more desired dog characteristic to search for (enter the search terms separated by commas)");
                readResult = Console.ReadLine();
                if (readResult != null)
                {
            ...
            dogCharacteristicArray = dogCharacteristic.Trim().ToLower().Split(',');
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    foreach (string term in dogCharacteristicArray)
                    {
                        if (term != null && term.Trim() != "")
                        {
                            ...
                            if (dogDescription.Contains(term.Trim()))
                            {
                                ...
                                Console.WriteLine($"Our dog {ourAnimals[i, 3]} is a match for your search for {term.Trim()}!");
            ...
            if (noMatchesDog)
            {
                Console.WriteLine("None of our dogs are a match found for: " + dogCharacteristic.Trim());
            }
