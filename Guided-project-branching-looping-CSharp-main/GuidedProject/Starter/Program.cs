    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    // Check if age field is empty and fill in it 
                    if (ourAnimals[i, 2] == "Age: " || ourAnimals[i, 2] == "Age: ?" || ourAnimals[i, 2] == "Age: tbd")
                    {
                        int petAge = 0;
                        do
                        {
                            Console.WriteLine($"Enter the pet's age for {ourAnimals[i, 0]}");
                            readResult = Console.ReadLine();
                            ...
                            if (readResult != null)
                            {
                                ...
                                if (animalAge != "?")
                                {
                                    entryValue = int.TryParse(animalAge, out petAge);
                                }
                                else
                                {
                                    entryValue = true;
                    ...
                    // Check if description field is empty and fill in it 
                    if (ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: ?" || ourAnimals[i, 4] == "Physical description: tbd")
                    {
                        string description = "";
        ...
        case "4":
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    // Check if nickname field is empty and fill in it
                    ...
                    // Check if personality description field is empty and fill in it 
                    if (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality: tbd" || ourAnimals[i, 5] == "Personality: ?")
                    {
                        string personality = "";
